		...
		<c:forEach items="${boardlist}" var="obj" varStatus="i">
			<tr align="center" valign="middle" bordercolor="#333333"
				...
				<td style="font-family: Tahoma; font-size: 10pt;">
					<div align="left">
						<c:choose>
							<c:when test="${obj.getBoard_Re_Lev() ne 0}">
								<c:forEach begin="0" end="${obj.getBoard_Re_Lev() *2 }">&nbsp;</c:forEach>
								▶
							</c:when>
							<c:otherwise>
							</c:otherwise>
						</c:choose>
						▶<a href="BoardDetailAction?num=${obj.getBoard_Num()}">${obj.getBoard_Subject()}</a>
					</div>
				</td>

				<td style="font-family: Tahoma; font-size: 10pt;">
					<div align="center">${obj.getBoard_Name()}</div>
				</td>
				<td style="font-family: Tahoma; font-size: 10pt;">
					<div align="center">${obj.getBoard_Date()}</div>
				</td>
				<td style="font-family: Tahoma; font-size: 10pt;">
					<div align="center">${obj.getBoard_ReadCount()}</div>
				</td>
			</tr>
		</c:forEach>
